...
public class SchoolApp {
    ...
    public void registrarComputador() {
        ...
        String result = computaricemos.agregarIncidenteEnComputador(date, serialNumber, description);
        System.out.println(result);
    }
    ...
    public void resolverIncidente() {
        System.out.print("Ingrese el numero serial del computador: ");
        String serialNumber = input.nextLine();
        ...
        input.nextLine(); 
        String result = computaricemos.solutionIncident(serialNumber, index, hours);
        System.out.println(result);
    }
}
